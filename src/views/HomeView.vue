<template>
    ...
    <div  class="grow flex   py-10 lg:px-6  lg:py-10  max-w-[1100px] my-[40px] text-neutral-800 dark:text-neutral-200 gap-5 justify-center items-center"><hollow-dots-spinner :animation-duration="1000" :dot-size="15" :dots-num="3" :color="'#0891b2'"/></div>
