<template>
  <div>
    <div class="flex w-full text-[40px] font-bold mt-[100px] mb-[50px] justify-center text-neutral-800 dark:text-neutral-200">
    ...
    <div class="flex flex-col sm:flex-row  items-center justify-center gap-7 text-neutral-800 dark:text-neutral-200">
