...
export const useCounterStore = defineStore('counter', {
  state: () => {
    return {
      ...
      class_2:'bg-gray-100 w-[15px] h-[5px] rounded opacity-100',Data_List_Product:[{'Category_Industry':''}],Data_List_Product_Home:[{Oder_Image:100}],
    }
  },
  ...
  actions: {
    ...
    async F_Data_List_Product_Home(){
      try{
        ...
        this.Data_List_Product_Home = [{Oder_Image:100}];
      }
  }
  }
})
