...
export const useCounterStore = defineStore('counter', {
  state: () => {
    return {
      domain_Backend:'http://127.0.0.1:8000',domain_Frontend:'https://www.webtoday.store/',Language:'vi',Dark:true,Table_Language:false,Table_Language_sm:false,Open_Dark:'darkk',Table_Nav:1,Table_Sidebar:1,Path_Route:useRoute(),
      ...
      Oder_Image:0,count:0,Table_Informations:false,Image_Language:'/assets/vn-2ac15179.svg',Text_Array:['Facebook','Zalo','Gọi điện'],class_1:'bg-gray-100 w-[15px] h-[5px] rounded opacity-50',mn:['a','b','c'],
